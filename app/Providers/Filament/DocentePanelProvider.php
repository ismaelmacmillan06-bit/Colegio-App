...
use App\Filament\Docente\Widgets\MarcarEntradaWidget;
...
class DocentePanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->widgets([MarcarEntradaWidget::class])
            ->renderHook(
                'panels::styles.after',
                fn(): HtmlString => new HtmlString($this->getInlineCss())
            )
            ->renderHook(
                'panels::head.end',
...
.fi-sidebar-group-label { font-size: 10px !important; font-weight: 700 !important; text-transform: uppercase !important; letter-spacing: 0.12em !important; color: rgba(255,255,255,0.3) !important; flex: 1 !important; }
.fi-sidebar-item-btn {
    display: flex !important; align-items: center !important; gap: 10px !important;
    padding: 10px 14px !important; margin: 1px 6px !important; border-radius: 8px !important;
    font-size: 14px !important; font-weight: 500 !important; color: rgba(255,255,255,0.72) !important;
    text-decoration: none !important; background-color: transparent !important;
    transition: background-color 0.12s ease, color 0.12s ease !important;
}
.fi-sidebar-item-btn:hover { background-color: rgba(16,185,129,0.15) !important; color: rgba(255,255,255,0.95) !important; }
.fi-sidebar-item.fi-active > .fi-sidebar-item-btn {
    background-color: rgba(16,185,129,0.22) !important; color: white !important;
    border-left: 3px solid #34d399 !important; padding-left: 11px !important;
}
...
.fi-sidebar-item.fi-active > .fi-sidebar-item-btn > .fi-icon { color: #6ee7b7 !important; }
...
.fi-topbar, .fi-topbar > nav, nav.fi-topbar {
    background: linear-gradient(90deg, #047857 0%, #059669 100%) !important;
    border-bottom: none !important; box-shadow: 0 2px 12px rgba(4,120,87,0.35) !important;
}
...
.fi-topbar .fi-dropdown-panel, .fi-topbar .fi-dropdown-panel * { color: #0f172a !important; background-color: revert !important; }
...
/* Login page */
.fi-simple-layout { display: flex !important; align-items: center !important; justify-content: center !important; min-height: 100vh !important; padding: 2rem !important; background: linear-gradient(135deg, #d1fae5 0%, #a7f3d0 55%, #6ee7b7 100%) !important; }
.fi-simple-main-ctn { width: 100% !important; max-width: 1040px !important; min-height: 0 !important; background: transparent !important; border-radius: 0 !important; box-shadow: none !important; padding: 0 !important; display: block !important; }
.fi-simple-main { width: 100% !important; max-width: none !important; background: transparent !important; min-height: 0 !important; padding: 0 !important; margin: 0 !important; box-shadow: none !important; display: block !important; }
...
.sc-card-wrapper { display: flex !important; align-items: stretch !important; width: 100% !important; min-height: 580px !important; border-radius: 24px !important; overflow: hidden !important; box-shadow: 0 30px 70px -30px rgba(13,40,28,.32), 0 4px 12px rgba(0,0,0,0.06) !important; }
.sc-form-side { flex-shrink: 0 !important; width: 440px !important; background: white !important; padding: 3.5rem 3rem !important; display: flex !important; flex-direction: column !important; justify-content: center !important; }
.sc-form-side .fi-section, .sc-form-side .fi-schema-section { background: transparent !important; border: none !important; box-shadow: none !important; border-radius: 0 !important; }
.sc-form-side .fi-section-content, .sc-form-side .fi-section-content-ctn { padding: 0 !important; }
.sc-form-side .fi-section-footer { padding: 0 !important; border-top: none !important; background: transparent !important; }
.sc-brand-side { flex: 1 1 0 !important; background: linear-gradient(150deg, #16a34a, #15803d 55%, #166534) !important; padding: 3rem 3.5rem !important; position: relative !important; overflow: hidden !important; display: flex !important; flex-direction: column !important; justify-content: center !important; }
